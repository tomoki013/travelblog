...
export default function Home() {
    ...
    return (
        <Elements.MainContainer>
            ...
            <Blog.DisplayPost type='diary' posts={diary} id='blog' styleType='style1' displayCount={5}> 
            ...
            <Blog.DisplayPost type='info' posts={info} id='travelinfo' styleType='style1' displayCount={5}>
                <Elements.NavigationItem
                    href="/travelinfo"
                    className="block underline text-[var(--color-one)] w-fit mx-auto hover:text-[var(--color-three)]"
                >
